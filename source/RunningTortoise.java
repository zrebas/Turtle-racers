/* autogenerated by Processing revision 1292 on 2024-01-30 */
...
public class RunningTortoise extends PApplet {
...
PImage finish;
 ...
 class Button{
    ...
    private String text;
    public int id;
    Button(int _x, int _y, int _w, int _h, int c, String _text, int _id, int _xoff, int _yoff){
      x = _x;
      y = _y;
      w = _w;
      h = _h;
    ...
    public void clicked(){fillColor = 0xFFEBB6D4;}
    public void unclicked(){fillColor = 0xFFFFDCF7;}
  }
 
 public void initColorButtons(){
   c1 = new Button(180, 400, 30,30,0xFF68C181, "", 1,0,0);
   c2 = new Button(230, 400, 30,30,0xFFC1B065, "", 2,0,0);
   c3 = new Button(280, 400, 30,30,0xFF547BC2, "", 3,0,0);
   c4 = new Button(330, 400, 30,30,0xFFC267AC, "", 4,0,0);
   c5 = new Button(800, 400, 30,30,0xFF68C181, "", 5,0,0);
   c6 = new Button(850, 400, 30,30,0xFFC1B065, "", 6,0,0);
   c7 = new Button(900, 400, 30,30,0xFF547BC2, "", 7,0,0);
   c8 = new Button(950, 400, 30,30,0xFFC267AC, "", 8,0,0);
 ...
 public void setup(){
    ...
    background(0xFF73C3BC);
    screen = 0;
    go = new Button(500, 500, 150,75,0xFF50B4AC, "GO!", 0, 25,60);
    initColorButtons();
    p1 = new Player(120,200,"zielony.png");
    p2 = new Player(750,200,"zolty.png");
    again = new Button(350,350,200,100,0xFF50B4AC, "AGAIN", 0, 15,70); 
    exit = new Button(650,350,200,100,0xFF50B4AC, "EXIT", 0, 40,70); 
 ...
 public void keyReleased(){
  ...
  static public void main(String[] passedArgs) {
    String[] appletArgs = new String[] { "RunningTortoise" };
    if (passedArgs != null) {
